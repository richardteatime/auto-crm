...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:fixed md:left-0 md:top-0 md:h-screen md:w-64 md:flex-col bg-[var(--sidebar)] text-[var(--sidebar-foreground)] overflow-y-auto">
      <div className="flex h-16 items-center gap-2 px-6 shadow-[0_1px_0_0_var(--sidebar-border)]">
